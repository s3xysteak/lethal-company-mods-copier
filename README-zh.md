...
- 准备好你的 mod 压缩包，可以是zip, rar...结构如下：
  - Mod 包.zip
    ...
    - winhttp.dll
- 确保你已经安装好致命公司。
- 运行`lethal-company-mods-copier.exe`，选择 mod 包，点击按钮等待完成，完成后可以直接关闭程序。
